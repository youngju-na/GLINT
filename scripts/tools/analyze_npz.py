...
def main():
    ...
    parser.add_argument('-i', '--input', default='data/trained_model/example/1599.npz', help='Path to the .npz file')
    parser.add_argument('-o', '--output', default='data/trained_model/example/1599.npz.info.xlsx', help='Output Excel file name')
