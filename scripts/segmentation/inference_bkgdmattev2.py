...
def main():
    ...
    parser.add_argument('--chkpt_path', type=str, default='data/weights/backgroundmattev2/torchscript_resnet101_fp32.pth')
    parser.add_argument('--data_root', type=str, default='data/example_scene')
