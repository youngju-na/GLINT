...
parser.add_argument('--inputs', nargs='+', default=['data/colmap/part1/sparse/0', 'data/colmap/part2/sparse/0'])
parser.add_argument('--output', default='data/colmap/merged/sparse/0')
