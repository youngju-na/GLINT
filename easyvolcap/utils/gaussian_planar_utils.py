...
def render(
    ...
    if not return_plane:
        rendered_image, radii, out_observe, _, _, _, _, _ = rasterizer(
            means3D = means3D,
            means2D = means2D,
    ...
    rendered_image, radii, out_observe, out_all_map, plane_depth, out_nearest_depth, out_transparency_map, output_specular_map = rasterizer(
        means3D = means3D,
        means2D = means2D,
        means2D_abs = means2D_abs,
        shs = shs,
    ...
    return_dict =  {"render": rendered_image,
                    ...
                    "transparency": out_transparency_map,
                    "specular": output_specular_map
                    }
